      ...
      <nav class="navbar navbar-expand-md  navbar-light bg-secondary" id="mainNavbar" ><!--oppretter navbar-->
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto"> <!--oppretter navbar Elementer-->
            ...
            <li class="nav-item active">
              <a class="nav-link" href="#">Projects <span class="sr-only">(current)</span></a><!--sr-only(current) brukes for at blinde skal vite hvilket alternativ som er valgt.-->
            </li>
              </ul>
              <div class="pull-right"><!--må ha en ny div for at bruker knappen skal legges helt til høyere på navbar-->
                ...
                <form class="form-inline my-2 my-lg-0 d-block d-sm-none"><!--søkefelt og søkeknapp må legges i en form tagg-->
          ...
          <div class="jumbotron text-center jumbotron-fluid bg-secondary d-none d-sm-block">
              <h1>Company</h1>
          ...
          <h3 class="text-center" id="textFont">Koll<span class="text-danger">B</span></h3><!--bruker JQ til å forandre fargen på "B" for fun-->
            <div class="wrapper"><!--bruker wrapper klassen for å bilde til å ligge i center av skjermen og holde en ok størrelse. fant ingen classe som fungerte på bilder, på samme måte som text-center gjør for tekst-->
              <img src="kolbe.jpg" class="mx-auto d-block " />
            </div>
